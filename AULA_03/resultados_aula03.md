...
def main():
    ...
    pygame.display.set_caption(
        "DEMO PROFESSOR: Raycasting e Percepção Sensorial"
    )
    ...
    while running:
        ...
        for i, texto in enumerate(leituras):
            screen.blit(
                font.render(texto, True, (220, 220, 220)),
                (20, 20 + i * 20)
            )

        screen.blit(
            font.render(
                "Mova o mouse para testar a detecção dos sensores.",
                True,
                (255, 215, 0)
            ),
            (20, 90)
